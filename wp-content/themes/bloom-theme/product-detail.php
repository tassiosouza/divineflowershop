...
<head>
    ...
    <link rel="stylesheet" href="assets/css/vendor/fontawsome.css">
...
<body >
    ...
    <main class="x-hidden">
                        ...
                        <div class="main-menu__left">
                            <div class="main-menu__logo">
                                <a href="index.html" class="logo">
                                    <img src="assets/media/logo.png" alt="Bloom">
                                </a>
                            </div>
        ...
        <div class="page-header">
            ...
            <img src="assets/media/bg/page-header-vec-1.png" alt="" class="left-vector">
            <img src="assets/media/bg/page-header-vec-2.png" alt="" class="right-vector">
        </div>
                                    ...
                                    <div class="row align-items-center row-gap-3">
                                        <div class="list">
                                            ...
                                            <div class="preview-slider-nav mt-3">
                                                <div class="detail-img-block">
                                                    <img alt=""  src="assets/media/products/product-image-slider-1.png">
                                                </div>
                                                <div class="detail-img-block">
                                                    <img alt=""  src="assets/media/products/product-image-slider-2.png">
                                                </div>
                                                <div class="detail-img-block">
                                                    <img alt=""  src="assets/media/products/product-image-slider-3.png">
                                                </div>
                                                <div class="detail-img-block">
                                                    <img alt=""  src="assets/media/products/product-image-slider-4.png">
                                                </div>
                                                <div class="detail-img-block">
                                                    <img alt=""  src="assets/media/products/product-image-slider-1.png">
                                                </div>
                                        ...
                                        <div class="preview">
                                            <div class="preview-slider">
                                                <div class="detail-img-block">
                                                    <img alt=""  src="./assets/media/products/pd-1.png">
                                                </div>
                                                <div class="detail-img-block">
                                                    <img alt=""  src="./assets/media/products/pd-2.png">
                                                </div>
                                                <div class="detail-img-block">
                                                    <img alt=""  src="./assets/media/products/pd-3.png">
                                                </div>
                                                <div class="detail-img-block">
                                                    <img alt=""  src="./assets/media/products/pd-4.png">
                                                </div>
                                                <div class="detail-img-block">
                                                    <img alt=""  src="./assets/media/products/pd-1.png">
                                                </div>
                        ...
                        <div class="about-product">
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    <button class="nav-link" id="nav-reviews-tab" data-bs-toggle="tab" data-bs-target="#nav-reviews" type="button" role="tab" aria-controls="nav-reviews" aria-selected="false">Customer Reviews</button>
                                </div>
                            </nav>
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-descriptions" role="tabpanel" aria-labelledby="nav-descriptions-tab">
                                    <p>
                                        Lorem ipsum dolor sit amet consectetur. Imperdiet placerat est libero magna semper id turpis tortor. Fusce enim laoreet habitant massa ipsum accumsan. Vitae ut urna duis felis sed mi pharetra a. A diam felis platea hac. Mi at at congue feugiat odio facilisi. <span class="br"></span>Arcu sit tortor fermentum rhoncus mauris elit tristique. Cursus egestas ornare risus quis. Iaculis vitae quis sed nulla enim pretium nisi fermentum. Faucibus dapibus semper a adipiscing amet rhoncus dictumst tristique turpis. Nisi massa vel pellentesque ullamcorper urna. Vitae sollicitudin viverra et arcu amet feugiat amet. Amet aenean ornare commodo enim. Convallis tellus lectus in urna facilisis feugiat. Tellus morbi velit ipsum duis. Enim sit iaculis sapien massa tellus fermentum at in elit. Lectus sed arcu etiam suscipit massa in. Quam commodo posuere ut semper ante quam. Eget ornare cras vel amet enim. Aliquam tincidunt sit sed sed purus dui.
                                    </p>
                                </div>
                                <div class="tab-pane fade" id="nav-reviews" role="tabpanel" aria-labelledby="nav-reviews-tab">
                                    <div class="reviews mb-48">
                                        <h5 class="mb-48">(2) REVIEWS</h5>
                                        <div class="review-block mb-24">
                                            <img src="assets/media/users/user_1.png" alt="">
                                            <div class="content">
                                                <h6 class="mb-8">Ethan Clarke</h6>
                                        ...
                                        <div class="review-block mb-48">
                                            <img src="assets/media/users/user_2.png" alt="">
                                            <div class="content">
                                                <h6 class="mb-8">Ethan Clarke</h6>
                                                <div class="rating mb-16">
                                                    <i class="fa-solid fa-star"></i>
                                    ...
                                    <form action="product-detail.html">
                                        <h6 class="mb-16">Write a Review</h6>
                                        <p class="mb-32">Your email address will not be published. Required fields are marked</p>
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group mb-24">
                                                    <label class="mb-16 accent-dark bold-text">Your Review</label>
                                                    <textarea name="review" autocomplete="off" rows="5" placeholder="Good quality"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group mb-24">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group mb-24">
                                                    <input type="email" name="mail" autocomplete="off" placeholder="Your Email">
                                                </div>
                                            </div>
                                        </div>
                                        <button type="submit" class="cus-btn sec-2">
                                            Submit
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
                            ...
                            <div class="product-card">
                                ...
                                <div class="text-block">
                                    ...
                                    <div class="action-block">
                                        ...
                                        <a href="javascript:;" class="cart-btn cart-button"><img src="assets/media/icons/cart.svg" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row row-gap-4  mb-32">
                        <div class="col-lg-3 col-md-6 col-sm-6 order-lg-1">
                            <div class="footer-widget">
                                <a href="index.html" class="mb-16"><img src="assets/media/logo.png" alt=""></a>
                    ...
                    <div class="footer-bottom">
                        <div class="row row-gap-4">
                            ...
                            <div class="col-sm-3 text-sm-end text-center">
                                <img src="assets/media/icons/payments.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="upper-block">
                ...
                <ul class="product-list">
                    <li class="product-item d-flex align-items-start justify-content-between mb-24">
                        <div class="product-block">
                            <a href="product-detail.html" class="img-block">
                                <img src="assets/media/products/m-cart-1.png" alt="Product Photo">
                            </a>
                    ...
                    <li class="product-item d-flex align-items-start justify-content-between mb-24">
                        <div class="product-block">
                            <a href="product-detail.html" class="img-block">
                                <img src="assets/media/products/m-cart-2.png" alt="Product Photo">
                            </a>
                            <div class="product-text">
                                <a href="product-detail.html" class="h6 mb-16">Jasmine Junction</a>
                                <p class="mb-8 accent-dark">Quantity: 1</p>
