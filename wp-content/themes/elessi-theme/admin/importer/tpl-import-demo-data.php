        ...
        if (!empty($required_plugins)) :
            ...
            foreach ($required_plugins as $plugin) :
                ...
                if (isset($plugin['auto']) && $plugin['auto']) :
                    ...
                    echo '<span class="plg-name">' . $plugin['name'] . '</span>';
            ...
            <div class="processing-demo-data">
                ...
                <ul class="processing-steps">
                    ...
                    <li class="step processing-revsliders" data-step="6">
                        ...
                        <ul class="sliders-import">
                            <?php foreach ($sliders as $key => $rev) : ?>
                                <li class="nasa-item-rev" data-file="<?php echo $key; ?>">
                                    <span class="rev-lbl"><?php echo $rev; ?></span>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    </li>
