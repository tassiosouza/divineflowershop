...
<div class="ns-homes-search nasa-flex jc">
    <div class="ns-homes-search-wrap">
        ...
        <label class="ns-label-search" for="ns-homes-search-input">
            <svg viewBox="0 0 80 80" width="26" height="26" fill="currentColor">
    ...
    <div class="nasa-tabs-panel">
        <?php if ($wpb_home) : ?>
            ...
            <div class="demo-homepages-wrap demo-homepages-wpb nasa-tab-content tab-content-js_composer">
                ...
                <div class="demo-homepage-item-wrap">
                    <a href="javascript:void(0);" data-home="gym-nutrition" class="demo-homepage-item">
                        <div class="img-wrap">
                            <img src="<?php echo ELESSI_THEME_URI; ?>/admin/assets/pages/gym-nutrition.jpg" alt="Gym Nutrition" />
                        </div>
        ...
        <?php if ($elm_home) : ?>
            ...
            <div class="demo-homepages-wrap demo-homepages-elm nasa-tab-content tab-content-elementor">
                ...
                <div class="demo-homepage-item-wrap">
                    <a href="javascript:void(0);" data-home="book" class="demo-homepage-item">
                        <div class="img-wrap">
                            <img src="<?php echo ELESSI_THEME_URI; ?>/admin/assets/pages/book-store.jpg" alt="Book" />
                        </div>

                        <h4 class="home-title">Books Store</h4>
                    </a>
                </div>

                <div class="demo-homepage-item-wrap">
                    <a href="javascript:void(0);" data-home="phone-case" class="demo-homepage-item">
                        <div class="img-wrap">
                            <img src="<?php echo ELESSI_THEME_URI; ?>/admin/assets/pages/phone-case.jpg" alt="Book" />
                        </div>

                        <h4 class="home-title">Phone Case</h4>
                    </a>
                </div>
