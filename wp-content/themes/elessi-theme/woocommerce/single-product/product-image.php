                    ...
                    <div class="nasa-main-image-default-wrap">
                        ...
                        <?php if ($sliders_arrow) : ?>
                            <div class="nasa-single-slider-arrows">
                                <a class="nasa-single-arrow nasa-disabled" data-action="prev" href="javascript:void(0);" rel="nofollow" aria-label="<?php echo esc_html('Previous arrow','elessi-theme')?>">
                                    <svg width="42" height="42" viewBox="0 0 32 32" fill="currentColor"><path d="M12.792 15.233l-0.754 0.754 6.035 6.035 0.754-0.754-5.281-5.281 5.256-5.256-0.754-0.754-3.013 3.013z"/></svg>
                                </a>
                                <a class="nasa-single-arrow nasa-disabled" data-action="next" href="javascript:void(0);" rel="nofollow" aria-label="<?php echo esc_html('Next arrow','elessi-theme')?>">
