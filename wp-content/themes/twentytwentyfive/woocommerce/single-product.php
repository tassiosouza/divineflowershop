                            ...
                            <div class="product-detail-content">
                                <div class="d-flex align-items-center column-gap-2 row-gap-3 mb-16">
                                    ...
                                    <?php if ( $product->is_in_stock() ) : ?>
                                        <p class="green-tag"><?php esc_html_e( 'In Stock', 'twentytwentyfive' ); ?></p>
                                    <?php endif; ?>
                                </div>
                                <ul class="unstyled mb-24 pro-rel">
                                    <li class="d-flex align-items-center">
                                        ...
                                        <span class="text-decoration-underline"><?php comments_number(); ?></span>
                                    </li>
                                    <?php if ( $product->get_sku() ) : ?>
                                        <li><span class="bold-text accent-dark me-1">SKU:</span><span><?php echo esc_html( $product->get_sku() ); ?></span></li>
                                    <?php endif; ?>
                                </ul>
                                ...
                                <p class="mb-24"><?php echo $product->get_short_description(); ?></p>
                                ...
                                <div class="mb-16">
                                    <span class="bold-text accent-dark me-1">SKU:</span><span><?php echo esc_html( $product->get_sku() ); ?></span>
                                </div>
                                <div class="tags mb-24">
                                    <span class="bold-text accent-dark me-1">Tag:</span><?php echo wc_get_product_tag_list( $product->get_id() ); ?>
                                </div>
                                <hr class="dash-line mb-16">
