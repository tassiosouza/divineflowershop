...
/**
 * Exposes WooCommerce Subscriptions' REST API v3 Subscription Notes endpoint via the Zapier Integration endpoint namespace.
 *
 * @since 2.9.0
 */
class Controller extends WC_REST_Subscription_notes_Controller {
	 ...
	 *
	 * Needed because the WooCommerce Subscriptions Notes Controller only supports getting notes for a specific subscription.
	 *
	...
	/**
	 * Ensure Notes belong to a WooCommerce Subscriptions and not other Order types.
	 *
