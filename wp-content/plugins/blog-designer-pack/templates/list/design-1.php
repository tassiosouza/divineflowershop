...
?>
<div class="bdpp-post-list-main <?php echo esc_attr( $atts['wrp_cls'] ); ?>">
	<div class="bdpp-post-list-content bdpp-clearfix">
		...
		<div class="bdpp-post-list-right <?php if ( ! $atts['feat_img'] ) { echo 'bdpp-col-1'; } else { echo 'bdpp-col-2'; } ?> bdpp-columns">
