...
?>
<div class="bdpp-post-slide <?php echo esc_attr( $atts['wrp_cls'] ); ?>">
	<div class="bdpp-post-carousel-content">
		<?php if ( $atts['feat_img'] ) { ?>
		<div class="bdpp-post-img-bg">
			<a href="<?php echo esc_url( $atts['post_link'] ); ?>">
				<img class="bdpp-img bdpp-post-feat-img" src="<?php echo esc_url( $atts['feat_img'] ); ?>" alt="<?php the_title_attribute(); ?>" />
			</a>
		</div>
		<?php } ?>
