...
if ( ! class_exists( 'Iconic_Flux_Settings_Framework' ) ) {
	/**
	 * Iconic_Flux_Settings_Framework class
	 */
	class Iconic_Flux_Settings_Framework {
		/**
		 * Settings wrapper.
		 *
		 * @var array
		...
		/**
		 * Iconic_Flux_Settings_Framework constructor.
		 *
