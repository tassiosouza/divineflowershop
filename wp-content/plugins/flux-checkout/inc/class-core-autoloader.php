...
if ( class_exists( 'Iconic_Flux_Core_Autoloader' ) ) {
	return;
}

/**
 * Iconic_Flux_Core_Autoloader.
 *
 * @class    Iconic_Flux_Core_Autoloader
 * @version  1.0.1
 */
class Iconic_Flux_Core_Autoloader {
	/**
	 * Single instance of the Iconic_Flux_Core_Autoloader object.
	 *
	 * @var Iconic_Flux_Core_Autoloader
	 */
	...
	/**
	 * Creates/returns the single instance Iconic_Flux_Core_Autoloader object.
	 *
	 * @param array $args Arguments.
	 *
	 * @return Iconic_Flux_Core_Autoloader
	 */
