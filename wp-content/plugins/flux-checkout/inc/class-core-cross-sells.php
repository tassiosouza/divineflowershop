...
if ( class_exists( 'Iconic_Flux_Core_Cross_Sells' ) ) {
	return;
}

/**
 * Iconic_Flux_Core_Cross_Sells.
 *
 * @class    Iconic_Flux_Core_Cross_Sells
 * @version  1.0.0
 */
class Iconic_Flux_Core_Cross_Sells {
	/**
	 ...
	 *
	 * @var Iconic_Flux_Core_License_Uplink
	 */
	...
	public static function get_plugin() {
		$class_name = 'Iconic_Flux_Checkout';
	...
	public static function get_api_sidebars() {
		...
		$sidebars  = self::get_remote_data( 'iconic_api_sidebars_flux-checkout', '/wp-json/wp/v2/iconic-api-sidebars?plugin_id=flux-checkout', $base_url );
