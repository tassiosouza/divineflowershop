...
if ( class_exists( 'Class_Prefix_Core_Cross_Sells' ) ) {
	return;
}

/**
 * Class_Prefix_Core_Cross_Sells.
 *
 * @class    Class_Prefix_Core_Cross_Sells
 * @version  1.0.0
 */
class Class_Prefix_Core_Cross_Sells {
	/**
	 ...
	 *
	 * @var Class_Prefix_Core_License_Uplink
	 */
	...
	public static function get_api_sidebars() {
		...
		$sidebars  = self::get_remote_data( 'iconic_api_sidebars_%textdomain%', '/wp-json/wp/v2/iconic-api-sidebars?plugin_id=%textdomain%', $base_url );
