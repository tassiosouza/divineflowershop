...
if ( class_exists( 'Class_Prefix_Core_Autoloader' ) ) {
	return;
}

/**
 * Class_Prefix_Core_Autoloader.
 *
 * @class    Class_Prefix_Core_Autoloader
 * @version  1.0.1
 */
class Class_Prefix_Core_Autoloader {
	/**
	 * Single instance of the Class_Prefix_Core_Autoloader object.
	 *
	 * @var Class_Prefix_Core_Autoloader
	 */
	...
	/**
	 * Creates/returns the single instance Class_Prefix_Core_Autoloader object.
	 *
	 * @param array $args Arguments.
	 *
	 * @return Class_Prefix_Core_Autoloader
	 */
