...
use Class_Prefix_NS\StellarWP\ContainerContract\ContainerInterface;
use Class_Prefix_NS\lucatume\DI52\Container as DI52Container;

/**
 * Class_Prefix_Core_Container.
 *
 * @class    Class_Prefix_Core_Container
 * @version  1.0.0
 */
class Class_Prefix_Core_Container implements ContainerInterface {
	/**
	 ...
	 *
	 * @return void
	 * @throws \Class_Prefix_NS\lucatume\DI52\ContainerException Throws exception.
	 */
