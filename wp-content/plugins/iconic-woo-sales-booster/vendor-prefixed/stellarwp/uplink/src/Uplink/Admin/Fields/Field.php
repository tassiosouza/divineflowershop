...
namespace Iconic_WSB_NS\StellarWP\Uplink\Admin\Fields;
...
use Iconic_WSB_NS\StellarWP\Uplink as UplinkNamespace;
use Iconic_WSB_NS\StellarWP\Uplink\Admin\Asset_Manager;
use Iconic_WSB_NS\StellarWP\Uplink\Admin\Group;
...
class Field {
	...
	public function get_placeholder(): string {
		return __( 'License key', 'iconic-wsb' );
	}
