...
if ( ! class_exists( 'Iconic_WSB_Settings_Framework' ) ) {
	/**
	 * Iconic_WSB_Settings_Framework class
	 */
	class Iconic_WSB_Settings_Framework {
		/**
		 * Settings wrapper.
		 *
		 * @var array
		...
		/**
		 * Iconic_WSB_Settings_Framework constructor.
		 *
