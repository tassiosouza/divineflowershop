...
class Iconic_WSB_Core_Cross_Sells {
	 ...
	 *
	 * @var Iconic_WSB_Core_License_Uplink
	 */
	...
	public static function get_plugin() {
		$class_name = 'Iconic_Woo_Sales_Booster';
	...
	public static function get_api_sidebars() {
		...
		$sidebars  = self::get_remote_data( 'iconic_api_sidebars_iconic-wsb', '/wp-json/wp/v2/iconic-api-sidebars?plugin_id=iconic-wsb', $base_url );
