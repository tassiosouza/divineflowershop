...
<div id="wppusher-welcome-panel" class="wppusher-welcome-panel welcome-panel">
    <a class="wppusher-welcome-panel-close welcome-panel-close" href="?page=wppusher&wppusher-welcome=0">Dismiss</a>
    <div class="wppusher-welcome-panel-content">
        <h3>Thanks for installing WP Pusher!</h3>
        <p class="about-description">Here's how to get started:</p>
        <div class="wppusher-welcome-panel-column-container">
            <div class="wppusher-welcome-panel-column">
            ...
            <div class="wppusher-welcome-panel-column wppusher-welcome-panel-last">
                <h4>More Actions</h4>
                <ul>
...
<h2 class="nav-tab-wrapper">
    ...
    <a href="?page=wppusher&tab=troubleshooting" title="Troubleshooting" class="nav-tab<?php echo $tab === 'troubleshooting' ? ' nav-tab-active' : null; ?>">Troubleshooting</a>
