...
if (is_object($term) && $term) {
    ...
    ?>
    <!-- Header type -->
    <tr class="form-field nasa-term-root hidden-tag term-cat_sidebar_layout-wrap ns-advance-field">
    ...
    ?>
    <!-- Header type -->
    <div class="form-field term-cat_sidebar_layout-wrap nasa-term-root hidden-tag ns-advance-field">
        <label for="<?php echo $this->_cat_sidebar_layout; ?>"><?php esc_html_e('Sidebar Layout', 'nasa-core'); ?></label>
        <?php
        echo '<p><select id="' . $this->_cat_sidebar_layout . '" name="' . $this->_cat_sidebar_layout . '">';
            foreach ($sidebarLayouts as $slug => $name) {
