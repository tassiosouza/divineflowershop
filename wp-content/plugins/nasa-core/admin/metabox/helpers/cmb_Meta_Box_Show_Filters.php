...
class cmb_Meta_Box_Show_Filters {
    ...
    public static function check_id($display, $meta_box) {
        ...
        return !$object_id ? false : in_array($object_id, (array) $meta_box['show_on']['value']);
    }
    ...
    public static function check_page_template($display, $meta_box) {
        ...
        return ($current_template && in_array($current_template, (array) $meta_box['show_on']['value'])) ? true : false;
    }
