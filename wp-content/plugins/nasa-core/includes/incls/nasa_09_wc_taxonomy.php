...
class Nasa_WC_Taxonomy {
    ...
    public function register_taxonomy() {
        ...
        $labels = array(
            ...
            'search_items' => __('Search Groups', 'nasa-core'),
            'all_items' => __('All Groups', 'nasa-core'),
            'parent_item' => __('Parent Group', 'nasa-core'),
            'parent_item_colon' => __('Parent Group:', 'nasa-core'),
            'edit_item' => __('Edit', 'nasa-core'),
            'update_item' => __('Update', 'nasa-core'),
            'add_new_item' => __('Add New', 'nasa-core'),
            'new_item_name' => __('New Group', 'nasa-core'),
        );
