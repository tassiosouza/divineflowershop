...
function nasa_register_search_posts(){
    $params = array(
        ...
        'description' => __("Display form search.", 'nasa-core'),
        "content_element" => true,
        "category" => 'Nasa Core',
        "params" => array(
            array(
                "type" => "textfield",
                "heading" => __('Label', 'nasa-core'),
            ...
            array(
                "type" => "textfield",
                "heading" => __('Button text', 'nasa-core'),
                "param_name" => "btn_text",
                "std" => 'Search'
            ),
            ...
            array(
                "type" => "dropdown",
                "heading" => __("Post Type", 'nasa-core'),
                "param_name" => "post_type",
                "value" => array(
                    __('Products - WooCommerce', 'nasa-core') => 'product',
                    __('Posts - Blogs', 'nasa-core') => 'post'
                ),
                "std" => 'post'
            ),
        )
