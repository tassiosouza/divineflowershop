    ...
    if ($('.nasa-compare-images').length) {
        $('.nasa-compare-images').each(function() {
            ...
            if (!$(_this).hasClass('nasa-inited')) {
                 ...
                 * Render img before
                 */
                var _before = $(_this).find('.before-img');
                
                var _class = $(_before).attr('class'),
                    _src = $(_before).attr('data-src'),
                    _width = $(_before).attr('data-width'),
                    _height = $(_before).attr('data-height'),
                    _alt = $(_before).attr('data-alt');
                    
                $(_before).replaceWith('<img class="' + _class + '" src="' + _src + '" width="' + _width + '" height="' + _height + '" alt="' + _alt + '" />');
                
                /**
                 * Render img after
                 */
                var _after = $(_this).find('.after-img');
                
                var _class = $(_after).attr('class'),
                    _src = $(_after).attr('data-src'),
                    _width = $(_after).attr('data-width'),
                    _height = $(_after).attr('data-height'),
                    _alt = $(_after).attr('data-alt');
                    
                $(_after).replaceWith('<img class="' + _class + '" src="' + _src + '" width="' + _width + '" height="' + _height + '" alt="' + _alt + '" />');
